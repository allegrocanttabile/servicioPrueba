...
<div class="box box-default">
	...
	<div class="box-body">
        ...
        $categorias = ControladorCategorias::ctrMostrarCategorias($item, $valor);
          ...
          echo ' <li><i class="fa fa-circle-o text-'.$colores[$i].'"></i> '.$categorias["categoria"].' '.$productos[$i]["marca"].' '.$productos[$i]["modelo"].'  </li>';
        ...
        $categorias = ControladorCategorias::ctrMostrarCategorias($item, $valor);
          		...
          		echo '<li>
						 ...
						 <img src="'.$productos[$i]["imagen"].'" class="img-thumbnail" width="60px" style="margin-right:10px"> 
						  ...
						  '.$categorias["categoria"].' '.$productos[$i]["marca"].' '.$productos[$i]["modelo"].'
