...
$('.tablaCotizacion').DataTable( {
    "ajax": "ajax/datatable-cotizacion.ajax.php?perfilOculto="+perfilOculto,
    "deferRender": true,
	"retrieve": true,
	"processing": true,
	 "language": {
...
$(".tablaCotizacion tbody").on("click", "button.btnEditarProducto", function(){
...
//
          $("#editarMarca2").val(respuesta["marca"]);
          $("#editarModelo2").val(respuesta["modelo"]);

//
           $("#editarId").val(respuesta["id"]);
           $("#editarCodigo").val(respuesta["codigo"]);
           $("#editarProveedor").val(respuesta["proveedor"]);
           $("#editarFecha_compra").val(respuesta["fecha_compra"]);
           $("#editarCourier").val(respuesta["courier"]);
           $("#editarSerie").val(respuesta["serie"]);
           $("#editarObs").val(respuesta["obs"]);
           $("#editarDescripcion").val(respuesta["descripcion"]);
           $("#editarStock").val(respuesta["stock"]);
           $("#editarPrecioCompra").val(respuesta["precio_compra"]);
           $("#editarPrecioTraida").val(respuesta["traida"]);
...
$(".tablaCotizacion tbody").on("click", "button.btnEliminarProducto", function(){
