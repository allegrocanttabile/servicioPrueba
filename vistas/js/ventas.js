                ...
                success: function(respuesta) {
                  ...
                  $(".nuevoProducto").append(
                    '<div class="row" style="padding:5px 15px">' +
                      ...
                      '<input type="text" class="form-control nuevaCategoria" idProducto="' +
                      idProducto +
                      '" name="agregarCategoria" value="' +
                      categoria +
                      '" readonly required>' +
                      "</div>" +
                      "</div>" +
                      '<div class="col-xs-3" style="padding-right:0px">' +
                      '<div class="input-group">' +
                      '<input type="text" class="form-control nuevaMarca" idProducto="' +
                      idProducto +
                      '" name="agregarMarca" value="' +
                      marca +
                      '" readonly required>' +
                      "</div>" +
                      "</div>" +
                      ...
                      '<div class="input-group">' +
                      '<input type="text" class="form-control nuevoModelo" idProducto="' +
                      idProducto +
                      '" name="agregarModelo" value="' +
                      modelo +
                      '" readonly required>' +
                      "</div>" +
                      "</div>" +
                      ...
                      '<div class="col-xs-3" style="padding-right:0px">' +
                      '<div class="input-group">' +
                      '<input type="text" class="form-control nuevoModeloSerie" idProducto="' +
                      idProducto +
                      '" name="agregarSerie" value="' +
                      serie +
                      '" readonly required>' +
                      "</div>" +
                      "</div>" +
    ...
    success: function(respuesta) {
      $(".nuevoProducto").append(
        '<div class="row" style="padding:5px 15px">' +
          ...
          idProducto +
          '"><i class="fa fa-times"></i></button></span>' +
          '<input type="text" class="form-control nuevoModeloProducto" idProducto="' +
          idProducto +
          '" name="agregarModelo" value="' +
          modelo +
          '" readonly required>' +
...
$(".tablas").on("click", ".btnImprimirFactura", function() {
  ...
  window.open(
    "extensiones/tcpdf/pdf/docGarantia.php?codigo=" + codigoVenta,
    "_blank"
  );
});
...
$("#daterange-btn").daterangepicker(
  ...
  function(start, end) {
    ...
    window.location =
      "index.php?ruta=ventas-total&fechaInicial=" +
      fechaInicial +
      "&fechaFinal=" +
      fechaFinal;
  }
...
$("#daterangeParcial-btn").daterangepicker(
  ...
  function(start, end) {
    $("#daterangeParcial-btn span").html(
      start.format("MMMM D, YYYY") + " - " + end.format("MMMM D, YYYY")
    );
    ...
    window.location =
      "index.php?ruta=ventas-parcial&fechaInicial=" +
      fechaInicial +
      "&fechaFinal=" +
      fechaFinal;
  }
